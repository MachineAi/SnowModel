...
c     &      form='unformatted',access='direct',recl=4*1*nx*ny)
          open (230,file='outputs/wo_assim/spre.gdat',
     &      form='unformatted',access='direct',recl=4*1*nx*ny)
...
c     &      form='unformatted',access='direct',recl=4*1*nx*ny)
c	      open (245,file='outputs/wo_assim/wbal.gdat',
c     &      form='unformatted',access='direct',recl=4*1*nx*ny)
...
c            write (227,rec=iter/iprint_inc2) ((albd(i,j),i=1,nx),j=1,ny)
            ...
            write (228,rec=iter/iprint_inc2) ((prec(i,j),i=1,nx),j=1,ny)
c            write (229,rec=iter/iprint_inc2) ((rpre(i,j),i=1,nx),j=1,ny)
            write (230,rec=iter/iprint_inc2) ((spre(i,j),i=1,nx),j=1,ny)
...
c            write (240,rec=iter/iprint_inc2) ((gmlt(i,j),i=1,nx),j=1,ny)
            write (241,rec=iter/iprint_inc2) ((csub(i,j),i=1,nx),j=1,ny)
c            write (245,rec=iter/iprint_inc2) ((wbal(i,j),i=1,nx),j=1,ny)
